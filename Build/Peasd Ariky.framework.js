...
// Begin JS library code
  ...
  function _GhostBridge_FinalizeAndGetPointer() {
  		var chunks = window.__ghostRecorderChunks || [];
  		var joined = chunks.join('');
  		var bufferSize = lengthBytesUTF8(joined) + 1;
  		var buffer = _malloc(bufferSize);
  		stringToUTF8(joined, buffer, bufferSize);
  		return buffer;
  	}
...
var wasmImports = {
  ...
  /** @export */
  GhostBridge_FinalizeAndGetPointer: _GhostBridge_FinalizeAndGetPointer,
  /** @export */
