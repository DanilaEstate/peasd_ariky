...
// include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/UserJsprePlaceholder.js


// end include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/UserJsprePlaceholder.js
// include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/AnimationFrameRate.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/AnimationFrameRate.js
// include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/Error.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/Error.js
// include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/FullScreen.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/FullScreen.js
// include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/IdbFs.js
if (typeof ENVIRONMENT_IS_PTHREAD === 'undefined' || !ENVIRONMENT_IS_PTHREAD) {
...
// end include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/IdbFs.js
// include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/MediaDevices.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/MediaDevices.js
// include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/PlayerConnection.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/PlayerConnection.js
// include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/SendMessage.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/SendMessage.js
// include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/WebPlayerInitilization.js
...
// end include: /Applications/Unity/Hub/Editor/6000.5.5f1/PlaybackEngines/WebGLSupport/BuildTools/prejs/WebPlayerInitilization.js
...
// Begin JS library code
  ...
  function _AdvertisementApi_HideBannerAd(successCallbackPtr, errorCallbackPtr) {
  ...
  function _AdvertisementApi_ShowBannerAd(positionPtr, successCallbackPtr, errorCallbackPtr) {
      const position = UTF8ToString(positionPtr);
      advertisementApi.showBannerAd(position, successCallbackPtr, errorCallbackPtr);
    }

  function _AdvertisementApi_ShowInterstitialAd(successCallbackPtr, errorCallbackPtr) {
      advertisementApi.showInterstitialAd(successCallbackPtr, errorCallbackPtr);
    }

  function _AdvertisementApi_ShowRewardedAd(successCallbackPtr, errorCallbackPtr) {
  ...
  function _AuthenticationApi_AuthenticateUser(requireSignin, successCallbackPtr, errorCallbackPtr) {
      authenticationApi.authenticateUser(requireSignin, successCallbackPtr, errorCallbackPtr);
    }

  function _AuthenticationApi_GetPlayerAccountHasPersonalProfileDataPermission() {
      return authenticationApi.getHasPersonalProfileDataPermission();
    }

  function _AuthenticationApi_GetPlayerAccountIsAuthorized() {
      return authenticationApi.getIsAuthorized();
    }

  function _AuthenticationApi_RequestProfilePermission(successCallbackPtr, errorCallbackPtr) {
      authenticationApi.requestProfilePermission(successCallbackPtr, errorCallbackPtr);
    }

  function _AuthenticationApi_StartAuthorizationPolling(repeatDelay, successCallbackPtr, errorCallbackPtr) {
  ...
  function _CloudStorageApi_LoadPlayerData(keyPtr, successCallbackPtr, errorCallbackPtr) {
      const key = UTF8ToString(keyPtr);
      cloudStorageApi.loadPlayerData(key, successCallbackPtr, errorCallbackPtr);
    }

  
  function _CloudStorageApi_SavePlayerData(keyPtr, dataJsonPtr, successCallbackPtr, errorCallbackPtr) {
      const key = UTF8ToString(keyPtr);
  ...
  function _FeedbackApi_CanReview(successCallbackPtr, errorCallbackPtr) {
      feedbackApi.canReview(successCallbackPtr, errorCallbackPtr);
    }

  function _FeedbackApi_RequestReview(successCallbackPtr, errorCallbackPtr) {
  ...
  function _GetLeaderboardPRating(lbName) {
  		let lbRatingData = {
  			Score: 0,
  			Rank: 0,
  			Error: false,
  ...
  function _GetLeaderboardRating(lbName, aroundPlayer, top, includePlayer) {
  ...
  function _GhostBridge_AppendChunk(chunkPtr) {
  		if (!window.__ghostRecorderChunks) {
  			window.__ghostRecorderChunks = [];
  			window.__ghostRecorderTotalChars = 0;
  		}
  		var chunk = UTF8ToString(chunkPtr);
  		window.__ghostRecorderChunks.push(chunk);
  		window.__ghostRecorderTotalChars += chunk.length;
  	}

  function _GhostBridge_Clear() {
  		window.__ghostRecorderChunks = [];
  		window.__ghostRecorderTotalChars = 0;
  	}

  function _GhostBridge_FreePointer(ptr) {
  		_free(ptr);
  	}

  function _GhostBridge_GetChunkCount() {
  		var chunks = window.__ghostRecorderChunks || [];
  		return chunks.length;
  	}

  function _GhostBridge_GetChunkPointer(index) {
  		var chunks = window.__ghostRecorderChunks || [];
  		var chunk = (index >= 0 && index < chunks.length) ? chunks[index] : '';
  		var bufferSize = lengthBytesUTF8(chunk) + 1;
  		var buffer = _malloc(bufferSize);
  		stringToUTF8(chunk, buffer, bufferSize);
  		return buffer;
  	}

  function _GhostBridge_GetTotalChars() {
  		return window.__ghostRecorderTotalChars || 0;
  	}

  function _GhostBridge_Reset() {
  		window.__ghostRecorderChunks = [];
  		window.__ghostRecorderTotalChars = 0;
  	}

  function _InitFinish(gameName, version, ysdkVersion) {
  ...
  function _LeaderboardApi_GetLeaderboardEntries(leaderboardNamePtr, quantityTop, 
  ...
  function _LeaderboardApi_GetPlayerEntry(leaderboardNamePtr, successCallbackPtr, errorCallbackPtr) {
      const leaderboardName = UTF8ToString(leaderboardNamePtr);
      leaderboardApi.getPlayerEntry(leaderboardName, successCallbackPtr, errorCallbackPtr);
    }

  
  function _LeaderboardApi_SubmitScore(leaderboardNamePtr, score, extraDataPtr, 
        successCallbackPtr, errorCallbackPtr) {
      const leaderboardName = UTF8ToString(leaderboardNamePtr);
  ...
  function _PurchaseApi_ConsumeProduct(purchaseTokenPtr, successCallbackPtr, errorCallbackPtr) {
  ...
  function _PurchaseApi_GetProductCatalog(successCallbackPtr, errorCallbackPtr) {
      purchaseApi.getProductCatalog(successCallbackPtr, errorCallbackPtr);
    }

  function _PurchaseApi_GetPurchasedProducts(successCallbackPtr, errorCallbackPtr) {
      purchaseApi.getPurchasedProducts(successCallbackPtr, errorCallbackPtr);
    }

  
  function _PurchaseApi_PurchaseProduct(productIdPtr, developerPayloadPtr, successCallbackPtr, errorCallbackPtr) {
  ...
  var _RequestLeaderboardDescription = function (lbName) {
  ...
  function _SetLeaderboardScore(lbName, value) {
  ...
  sendResponse:function(successCallbackPtr, errorCallbackPtr, data, error) {
        ...
        try {
            if (error) {
              getWasmTableEntry(errorCallbackPtr) (jsonPtr);
              ...
              getWasmTableEntry(successCallbackPtr) (jsonPtr);
              // see https://docs.unity3d.com/6000.0/Documentation/Manual/web-interacting-browser-deprecated.html#dyncall
  ...
  function _YandexGamesPlugin_GetDeviceType() {
      return yandexGamesPlugin.getDeviceType();
    }

  function _YandexGamesPlugin_GetEnvironment(successCallbackPtr, errorCallbackPtr) {
      yandexGamesPlugin.getEnvironment(successCallbackPtr, errorCallbackPtr);
    }

  function _YandexGamesPlugin_GetServerTime(successCallbackPtr, errorCallbackPtr) {
      yandexGamesPlugin.getServerTime(successCallbackPtr, errorCallbackPtr);
    }

  function _YandexGamesPlugin_Initialize(successCallbackPtr, errorCallbackPtr) {
      yandexGamesPlugin.initialize(successCallbackPtr, errorCallbackPtr);
    }

  function _YandexGamesPlugin_IsInitialized() {
      return yandexGamesPlugin.isInitializedGetter();
    }

  function _YandexGamesPlugin_IsRunningOnYandex() {
      return yandexGamesPlugin.isRunningOnYandex() ? 1 : 0;
    }

  function _YandexGamesPlugin_SetGameplayReady(successCallbackPtr, errorCallbackPtr) {
      yandexGamesPlugin.setGameplayReady(successCallbackPtr, errorCallbackPtr);
    }

  function _YandexGamesPlugin_SetGameplayStart(successCallbackPtr, errorCallbackPtr) {
      yandexGamesPlugin.setGameplayStart(successCallbackPtr, errorCallbackPtr);
    }

  function _YandexGamesPlugin_SetGameplayStop(successCallbackPtr, errorCallbackPtr) {
...
var wasmImports = {
  /** @export */
  AdvertisementApi_HideBannerAd: _AdvertisementApi_HideBannerAd,
  /** @export */
  AdvertisementApi_ShowBannerAd: _AdvertisementApi_ShowBannerAd,
  /** @export */
  AdvertisementApi_ShowInterstitialAd: _AdvertisementApi_ShowInterstitialAd,
  /** @export */
  AdvertisementApi_ShowRewardedAd: _AdvertisementApi_ShowRewardedAd,
  /** @export */
  AuthenticationApi_AuthenticateUser: _AuthenticationApi_AuthenticateUser,
  /** @export */
  AuthenticationApi_GetPlayerAccountHasPersonalProfileDataPermission: _AuthenticationApi_GetPlayerAccountHasPersonalProfileDataPermission,
  /** @export */
  AuthenticationApi_GetPlayerAccountIsAuthorized: _AuthenticationApi_GetPlayerAccountIsAuthorized,
  /** @export */
  AuthenticationApi_RequestProfilePermission: _AuthenticationApi_RequestProfilePermission,
  /** @export */
  AuthenticationApi_StartAuthorizationPolling: _AuthenticationApi_StartAuthorizationPolling,
  /** @export */
  CloudStorageApi_LoadPlayerData: _CloudStorageApi_LoadPlayerData,
  /** @export */
  CloudStorageApi_SavePlayerData: _CloudStorageApi_SavePlayerData,
  /** @export */
  FeedbackApi_CanReview: _FeedbackApi_CanReview,
  /** @export */
  FeedbackApi_RequestReview: _FeedbackApi_RequestReview,
  /** @export */
  GetEnviroment: _GetEnviroment,
  /** @export */
  GetJSLoadTimeInfo: _GetJSLoadTimeInfo,
  /** @export */
  GetJSMemoryInfo: _GetJSMemoryInfo,
  /** @export */
  GetLeaderboardPRating: _GetLeaderboardPRating,
  /** @export */
  GetLeaderboardRating: _GetLeaderboardRating,
  /** @export */
  GhostBridge_AppendChunk: _GhostBridge_AppendChunk,
  /** @export */
  GhostBridge_Clear: _GhostBridge_Clear,
  /** @export */
  GhostBridge_FreePointer: _GhostBridge_FreePointer,
  /** @export */
  GhostBridge_GetChunkCount: _GhostBridge_GetChunkCount,
  /** @export */
  GhostBridge_GetChunkPointer: _GhostBridge_GetChunkPointer,
  /** @export */
  GhostBridge_GetTotalChars: _GhostBridge_GetTotalChars,
  /** @export */
  GhostBridge_Reset: _GhostBridge_Reset,
  /** @export */
  ...
  /** @export */
  LeaderboardApi_GetLeaderboardEntries: _LeaderboardApi_GetLeaderboardEntries,
  /** @export */
  LeaderboardApi_GetPlayerEntry: _LeaderboardApi_GetPlayerEntry,
  /** @export */
  LeaderboardApi_SubmitScore: _LeaderboardApi_SubmitScore,
  /** @export */
  PurchaseApi_ConsumeProduct: _PurchaseApi_ConsumeProduct,
  /** @export */
  PurchaseApi_GetProductCatalog: _PurchaseApi_GetProductCatalog,
  /** @export */
  PurchaseApi_GetPurchasedProducts: _PurchaseApi_GetPurchasedProducts,
  /** @export */
  PurchaseApi_PurchaseProduct: _PurchaseApi_PurchaseProduct,
  /** @export */
  Rate: _Rate,
  /** @export */
  RequestLeaderboardDescription: _RequestLeaderboardDescription,
  /** @export */
  SetLeaderboardScore: _SetLeaderboardScore,
  /** @export */
  ShowAd: _ShowAd,
  /** @export */
  ShowRewardedAd: _ShowRewardedAd,
  /** @export */
  YandexGamesPlugin_GetDeviceType: _YandexGamesPlugin_GetDeviceType,
  /** @export */
  YandexGamesPlugin_GetEnvironment: _YandexGamesPlugin_GetEnvironment,
  /** @export */
  YandexGamesPlugin_GetServerTime: _YandexGamesPlugin_GetServerTime,
  /** @export */
  YandexGamesPlugin_Initialize: _YandexGamesPlugin_Initialize,
  /** @export */
  YandexGamesPlugin_IsInitialized: _YandexGamesPlugin_IsInitialized,
  /** @export */
  YandexGamesPlugin_IsRunningOnYandex: _YandexGamesPlugin_IsRunningOnYandex,
  /** @export */
  YandexGamesPlugin_SetGameplayReady: _YandexGamesPlugin_SetGameplayReady,
  /** @export */
  YandexGamesPlugin_SetGameplayStart: _YandexGamesPlugin_SetGameplayStart,
  /** @export */
  YandexGamesPlugin_SetGameplayStop: _YandexGamesPlugin_SetGameplayStop,
  /** @export */
